...
int main(int argv,char** argc)
{
    if(!strcmp(argc[1],"help"))
        ...
        if (!(strcmp(argc[1], "add"))) {
        ...
        else if (!(strcmp(argc[1], "substract"))) {p2:
            cout << "\tMACIERZ I" << endl;
            cout << "Podaj liczbe wierszy" << endl;
            cin >> liczba_wierszy_a;
            cout << "Podaj liczbe kolumn" << endl;
            ...
            if (liczba_wierszy_a == liczba_wierszy_b && liczba_kolumn_a == liczba_kolumn_b) {
                ...
                printMatrix(macierz_b, liczba_wierszy_b, liczba_kolumn_b);
                int **macierz_c = createMatrix(liczba_wierszy_a, liczba_kolumn_a);
                macierz_c = substractMatrix(macierz_a, macierz_b, liczba_wierszy_a, liczba_kolumn_a, liczba_wierszy_b,
                                            liczba_kolumn_b);
        ...
        else if (!(strcmp(argc[1], "multiply"))) {p3:
            cout << "\tMACIERZ I" << endl;
            cout << "Podaj liczbe wierszy" << endl;
            cin >> liczba_wierszy_a;
            cout << "Podaj liczbe kolumn" << endl;
            ...
            if (liczba_kolumn_a == liczba_wierszy_b) {
                ...
                macierz_c = multiplyMatrix(macierz_a, macierz_b, liczba_wierszy_a, liczba_kolumn_a, liczba_kolumn_b);
        ...
        else if (!(strcmp(argc[1], "multiplyByScalar"))) {p4:
            cout << "\tMACIERZ" << endl;
            cout << "Podaj liczbe wierszy" << endl;
            cin >> liczba_wierszy_a;
            cout << "Podaj liczbe kolumn" << endl;
        ...
        else if (!(strcmp(argc[1], "transpoze"))) {p5:
            cout << "\tMACIERZ" << endl;
            cout << "Podaj liczbe wierszy" << endl;
            cin >> liczba_wierszy_a;
            cout << "Podaj liczbe kolumn" << endl;
        ...
        else if (!(strcmp(argc[1], "matrixIsDiagonal"))) {p8:
            cout << "\tMACIERZ I" << endl;
            cout << "Podaj liczbe wierszy" << endl;
            cin >> liczba_wierszy_a;
            cout << "Podaj liczbe kolumn" << endl;
    ...
    else if(!(strcmp(argc[2], "double")))
    {
        ...
        else if (!(strcmp(argc[1], "substract"))) {p11:
            cout << "\tMACIERZ I" << endl;
            cout << "Podaj liczbe wierszy" << endl;
            cin >> liczba_wierszy_a;
            cout << "Podaj liczbe kolumn" << endl;
        ...
        else if (!(strcmp(argc[1], "multiply"))) {p12:
            cout << "\tMACIERZ I" << endl;
            cout << "Podaj liczbe wierszy" << endl;
            cin >> liczba_wierszy_a;
            cout << "Podaj liczbe kolumn" << endl;
        ...
        else if (!(strcmp(argc[1], "multiplyByScalar"))) {p13:
            cout << "\tMACIERZ" << endl;
            cout << "Podaj liczbe wierszy" << endl;
            cin >> liczba_wierszy_a;
            cout << "Podaj liczbe kolumn" << endl;
        ...
        else if (!(strcmp(argc[1], "transpoze"))) {p14:
            cout << "\tMACIERZ" << endl;
            cout << "Podaj liczbe wierszy" << endl;
            cin >> liczba_wierszy_a;
            cout << "Podaj liczbe kolumn" << endl;
        ...
        else if (!(strcmp(argc[1], "power"))) {p15:
            unsigned int stopien_potegi;
            cout << "\tMACIERZ I" << endl;
            cout << "Podaj liczbe wierszy" << endl;
            cin >> liczba_wierszy_a;
        ...
        else if (!(strcmp(argc[1], "diagonal"))) {p17:
            cout << "\tMACIERZ I" << endl;
            cout << "Podaj liczbe wierszy" << endl;
            cin >> liczba_wierszy_a;
            cout << "Podaj liczbe kolumn" << endl;
        ...
        else if (!(strcmp(argc[1], "SortRow"))) {p19:
